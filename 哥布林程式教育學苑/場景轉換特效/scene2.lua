...
init = function (sceneGroup)
	...
	-- bg = display.newRect( 160 , 240 , _SCREEN.WIDTH , _SCREEN.HEIGHT )
	-- bg:setFillColor(1,0,1)

	bg = display.newImageRect( sceneGroup , "images/scene.jpg", _SCREEN.WIDTH, _SCREEN.HEIGHT )
	bg.x , bg.y = _SCREEN.CENTER.X , _SCREEN.CENTER.Y

	text = display.newText( sceneGroup , "有木有？\n輕輕閃一下進入場景了 ..." , 160 , 420 , native.systemFont , 25 )
