...
funPlayAudio = function( _path , _channel )
	varSound = audio.play( _path , { channel = _channel } )
	return varSound
end

funScene = function()
	varGotoScene2:addEventListener( "tap", funOnClick )
end
...
funOnClick = function()
	...
	varGotoScene2:removeEventListener( "tap" , funOnClick )
end
...
function scene:show( e )
	...
	elseif ( "did" == phase ) then
		...
		varGotoScene2:addEventListener( "tap" , funScene ) -- 畫面推上螢幕後，開始偵聽前往場景二的按鈕是否觸發
